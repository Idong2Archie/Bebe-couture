// source --> https://www.tailorontheroad.com.au/wp-content/plugins/popup-builder/public/js/PopupBuilder.js?ver=3.68.3 
...
// source --> https://www.tailorontheroad.com.au/wp-content/plugins/afterpay-gateway-for-woocommerce/js/afterpay.js?ver=5.5 
			...
			if ($currency == 'USD') {
				if ($(window).width() > 640) {
					$img.attr({
						...
						'srcset': 'https://static.afterpay.com/us-popup-medium.png 1x, https://static.afterpay.com/us-popup-medium@2x.png 2x'
					});
				} else {
					$img.attr({
						'src': 'https://static.afterpay.com/us-popup-small.png',
						'srcset': 'https://static.afterpay.com/us-popup-small.png 1x, https://static.afterpay.com/us-popup-small@2x.png 2x'
					});
				}
			} else {
				if ($(window).width() > 640) {
					...
					$img.attr({
						...
						'srcset': 'https://static.afterpay.com/lightbox-mobile.png 1x, https://static.afterpay.com/lightbox-mobile@2x.png 2x, https://static.afterpay.com/lightbox-mobile@3x.png 3x'
					});
				}
			}
